class PlayScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("bgi", "image/bgi.jpg");
        this.load.image("bgii", "image/bgii.jpg");  
        this.load.image("bgiii", "image/bgiii.jpg");  

        // Player + Coins
        this.load.spritesheet("--", "image/character.png", {
            frameWidth: 64,
            frameHeight: 64
        });
    ...
    create() {
        ...
        this.boy = this.physics.add.sprite(startX, startY, "--");
